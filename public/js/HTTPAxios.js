    ...
    function mostrar(data){
        ...
        // res.innerHTML = "<tr><th>ID</th><th>Matricula</th><th>Nombre</th><th>Domicilio</th><th>Sexo</th><th>Especialidad</th></tr>"
            ...
            for(item of data){
                    ...
                    res.innerHTML += '<input type="number" name="matricula" id="matricula" placeholder="'+ item.matricula +'" required="true" class="form-control" style="margin-left: 5px; width: 250px;">'+
                    +'<input type="text" name="nombre" id="nombre" placeholder="'+ item.nombre +'" class="form-control" style="margin-left: 5px; width: 250px;">'+
                    +'<input type="text" name="domicilio" id="domicilio" placeholder="Domicilio" class="form-control" style="margin-left: 5px; width: 250px;">';
            }
    }
}
}
